                                    ...
                                    {sortedRepo.map(rep => (
                                        <div key={rep.id} className="repo-card" >
                                            <div className="content">
                                                ...
                                                <NavLink to={`/repo-stats/${userName}/${rep.name}/${rep.id}`} style={{ color: 'white' }} href=""><div style={{ backgroundColor: '#10147d', padding: '8px 16px', borderRadius: '30px' }} className='home' >View</div></NavLink>
                                            </div>
                                            <div className="meta">
